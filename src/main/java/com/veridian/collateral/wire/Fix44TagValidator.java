...
public final class Fix44TagValidator {
    ...
    private void registerDefaults() {
        ...
        register(10, checksum("CheckSum"));
        register(55, symbol("Symbol"));
        register(53, positiveQty("Quantity"));
        register(909, pct("CollateralHaircut"));
        register(910, amount("CollateralValue"));
        register(911, enumStatus("PledgeStatus"));
        register(912, amount("MarginExcess"));
        register(913, amount("MarginDeficit"));
        register(914, required("VaultLocation"));
        register(916, assetClass("EligibleAssetClass"));
        register(917, pct("ConcentrationLimit"));
        register(919, positiveInt("SettlementCycle"));
        register(920, required("PledgeEnvelopeId"));
        register(921, required("LegReference"));
        register(922, signedDecimal("BasisAdjustment"));
        register(923, tier("LiquidityTier"));
        register(924, required("NostroAccount"));
        register(925, amount("SweepThreshold"));
        register(926, required("ComplianceRuleId"));
        register(927, positiveInt("AuditSequence"));
        register(928, hexHash("CheckpointHash"));
        register(929, timestamp("MarginCallDeadline"));
